# Using SQL – Enumeration

Trouble viewing this document? See the online version at 
[https://exceltographviz/sql/enumerate](https://exceltographviz/sql/enumerate)
...
In the **Iteration** example we built a timeline of Unix shell introductions. The dataset contains a `Year` column, but the years are sparse:
