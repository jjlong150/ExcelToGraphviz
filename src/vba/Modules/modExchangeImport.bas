...
Private Sub ImportSettingsSql(ByVal dictionaryObj As Dictionary)
    ...
    If dictionaryObj.Exists(JSON_SETTINGS_SQL_FIELD_NAME_CLUSTER_LEVEL_PLACEHOLDER) Then
        RestoreSetting SETTINGS_SQL_COUNT_PLACEHOLDER_LEVEL, dictionaryObj.item(JSON_SETTINGS_SQL_FIELD_NAME_CLUSTER_LEVEL_PLACEHOLDER)
    End If
    
    If dictionaryObj.Exists(JSON_SETTINGS_SQL_FIELD_NAME_CLUSTER_MAX_LEVELS) Then
        RestoreSetting SETTINGS_SQL_MAX_CLUSTER_LEVELS, dictionaryObj.item(JSON_SETTINGS_SQL_FIELD_NAME_CLUSTER_MAX_LEVELS)
    End If
    ...
    ' Concatenate Query settings
    If dictionaryObj.Exists(JSON_SETTINGS_SQL_FIELD_NAME_CONCATENATE_SWITCH) Then
        RestoreSetting SETTINGS_SQL_FIELD_NAME_CONCATENATE_SWITCH, dictionaryObj.item(JSON_SETTINGS_SQL_FIELD_NAME_CONCATENATE_SWITCH)
    End If
    
    If dictionaryObj.Exists(JSON_SETTINGS_SQL_FIELD_NAME_CONCATENATE_FIELD) Then
        RestoreSetting SETTINGS_SQL_FIELD_NAME_CONCATENATE_FIELD, dictionaryObj.item(JSON_SETTINGS_SQL_FIELD_NAME_CONCATENATE_FIELD)
    End If
    
    If dictionaryObj.Exists(JSON_SETTINGS_SQL_FIELD_NAME_CONCATENATE_MAP_TO) Then
        RestoreSetting SETTINGS_SQL_FIELD_NAME_CONCATENATE_MAP_TO, dictionaryObj.item(JSON_SETTINGS_SQL_FIELD_NAME_CONCATENATE_MAP_TO)
    End If
    
    If dictionaryObj.Exists(JSON_SETTINGS_SQL_FIELD_NAME_CONCATENATE_PREFIX) Then
        RestoreSetting SETTINGS_SQL_FIELD_NAME_CONCATENATE_PREFIX, dictionaryObj.item(JSON_SETTINGS_SQL_FIELD_NAME_CONCATENATE_PREFIX)
    End If
    
    If dictionaryObj.Exists(JSON_SETTINGS_SQL_FIELD_NAME_CONCATENATE_SUFFIX) Then
        RestoreSetting SETTINGS_SQL_FIELD_NAME_CONCATENATE_SUFFIX, dictionaryObj.item(JSON_SETTINGS_SQL_FIELD_NAME_CONCATENATE_SUFFIX)
    End If
    
    If dictionaryObj.Exists(JSON_SETTINGS_SQL_FIELD_NAME_CONCATENATE_SEPARATOR) Then
        RestoreSetting SETTINGS_SQL_FIELD_NAME_CONCATENATE_SEPARATOR, dictionaryObj.item(JSON_SETTINGS_SQL_FIELD_NAME_CONCATENATE_SEPARATOR)
    End If
