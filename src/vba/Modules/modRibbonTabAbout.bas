...
Private Sub aboutHelp_onAction(ByVal control As IRibbonControl)
...
Private Sub aboutE2G_onAction(ByVal control As IRibbonControl)
...
Private Sub aboutSourceForge_onAction(ByVal control As IRibbonControl)
...
Private Sub aboutGithub_onAction(ByVal control As IRibbonControl)
...
Private Sub aboutAuthorLinkedIn_onAction(ByVal control As IRibbonControl)
...
Private Sub aboutAuthorEmail_onAction(ByVal control As IRibbonControl)
...
Private Sub aboutBuyMeACoffee_onAction(ByVal control As IRibbonControl)
