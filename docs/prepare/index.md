...
description: Learn how to create a new Relationship Visualizer workbook, save it as a macro‑enabled file, resolve Excel security prompts, and ensure the custom Graphviz ribbon loads correctly.
---
