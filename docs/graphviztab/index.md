...
![Graphviz ribbon tab on Windows.](../media/ribbon_tab_graphviz.png)

`macOS`

![Graphviz ribbon tab on macOS.](./mac_ribbon_graphviz.png)
...
| :---- | :--- |  :--- |
| [Visualize](#visualize) | ![Visualize group icons.](./graphviz_tab_visualize.png) | Action and option buttons that cause the Excel data to be graphed by Graphviz and then displayed within the Excel workbook. |
| | | |
| [Publish](#publish) | ![Publish group icons.](./graphviz_tab_publish.png) | Action buttons that cause the Excel data to be graphed by Graphviz and then written to a file. |
| | | |
| [Graph Layout](#graph-layout) | ![Graph Layout group icons.](./graphviz_tab_graph_layout.png) | Provides a set of toggle buttons that control which Graphviz layout engine is applied to your diagram. |
| | | |
| [Splines](#splines) | ![Splines group icons.](./graphviz_tab_splines.png) | Provides a set of toggle buttons that control how edges are routed in your diagram.  |
| | | |
| [Type](#graph-type) | ![Graph Type group icons.](./graphviz_tab_graph_type.png) | Provides a set of toggle buttons that determine whether your diagram is treated as a directed or undirected graph. |
| | | |
| [Drawn First](#drawn-first) | ![Drawn First group icons.](./graphviz_tab_drawn_first.png) | Provides a set of toggle buttons that determine the sequence in which Graphviz draws nodes and edges during rendering. |
| | | |
| [Layout Options](#layout-options) | ![Layout Options group icons.](./graphviz_tab_layout_dot.png) | The Algorithm group within the Graphviz tab changes dynamically based upon the layout algorithm chosen. The graph options shown are specific to that particular layout algorithm. |
| | | |
| ['data' Worksheet](#data-worksheet) | ![Data worksheet group icons.](./graphviz_tab_data_worksheet.png) | A set of menu items that control what columns and graphs are displayed on the `data` worksheet. |
| | | |
| [Debug](#debug) | ![Debug group icons.](./graphviz_tab_debug.png) | An option to display additional information such as the row number and Item identifiers in the labels of nodes, edges, and clusters. |
| | | |
| [Help](#help) | ![Help group icons.](./graphviz_tab_help.png) | Provides a link to the `Help` content for the `data` worksheet (i.e. this web page). |

## Visualize

| ![Screenshot of Visualize group ribbon controls](./graphviz_tab_visualize.png) |
| --------------------------------------------- |
...
| ![Screenshot of Publish group ribbon controls](./graphviz_tab_publish.png) |
| ---------------------------------------- |
...
| Filename options ![Filename options icon.](../media/1465e831936eb17643562925f209022d.png) | Dropdown List | A list of options which can be checked which will cause run-time information to be appended or omitted from the file name. |
...
| ![Screenshot of layout=twopi group ribbon controls](./graphviz-ribbon-options.png) |
| ---------------------------------- |
...
| Transparent Background | Checkbox | Toggles the background color between white and transparent.<br><br>Transparent backgrounds are useful if you intend to layer the graphs in an image editor or paste them into a Microsoft Word document.<br><br>**Choices:**<br><ul><li>_Checked_ - Background is transparent<br><br>![Transparent background example.](../media/dc86a760a2e0be24c37a4b1985b9ecf7.png)</li><li>_Unchecked_ - Graph background is white.<br><br>![White background example.](../media/a332d31c7264ff50fc6f421bcb17245a.png)</li></ul>**Note:** It is possible to set the graph background color to any valid color by specifying the `bgcolor=` attribute as a graph option on the `settings` worksheet. |
...
| Include Ports | Checkbox | Retain/Remove port values from the nodes in an edge relationship. Given: ![Example showing port notation on nodes.](../media/a6c39d81330c71bda84cc17f25d12c7b.png) <br><br>**Choices:**<ul><li>_Checked_ - retain the ports when creating the edge syntax.<br>![Edge syntax with ports included.](../media/0a90b4bf4ef3f9f623188128ee5abc60.png)<br>`a:n -> b:s` </li><li>_Unchecked_ - removes the ports specified when creating the edge syntax.<br>![Edge syntax with ports removed.](../media/13fb7df4516da5165ef091918380243b.png)<br>`a -> b`</li></ul> |
| **Label Columns**                                                       |               |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| **Label Values**                                                        |               |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| When the `Label` column is blank... | Menu | Include or exclude blank values in the Label column?<br><br>When the `Label` column is blank on the data worksheet on a row which refers to an edge it can mean two possible things. One interpretation is to remove the label from the edge. The other interpretation is to let the graph default to displaying the value Graphviz assigns to the edge relationship. <br><br>**Choices:**<ul><li>`...the label is blank` - use the blank label as the node's label text <br>![Edge with blank label example.](../media/13fb7df4516da5165ef091918380243b.png)</li><li>`...use the edge name as the label` - show the value in the `Item` column as the label text<br>![Edge using Item value as label example.](../media/6567f5f5ad4d485b68dd2ec0f3a6bbd3.png)</li></ul> |

## Toggles

| ![Screenshot of Graphviz ribbon Toggles group controls.](./graphviz-ribbon-toggles.png) |
| ------- |
...
| ![Screenshot of Graphviz ribbon 'data' Worksheet group controls](./graphviz_tab_data_worksheet.png) |
| ------- |
...
| ![Screenshot of Graphviz ribbon Help group controls](./graphviz_tab_help.png) |
| ------- |
