...
| A | B | C | D |
|---|---|---|---|
| [Indicator](./#indicator) | [SQL SELECT Statement](./#sql-select-statement) | [Excel data file](./#excel-data-file) |[Status](./#status) |
...
- An `!` exclamation mark character will appear if errors are detected in your data on this row. The Status will turn red, and an error message will be displayed in the [Status](./#status) column.
