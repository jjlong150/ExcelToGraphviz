...
![Graphviz diagram generated by the Relationship Visualizer showing seven rectangle‑shaped continent nodes, each containing a newline‑separated list of countries produced through SQL iteration and concatenation.](./example1.png)
...
![Graphviz diagram using record‑shaped nodes for each continent, with country names concatenated into brace‑and‑pipe { ... | ... } record fields via SQL iteration in the Relationship Visualizer.](./example2.png)
