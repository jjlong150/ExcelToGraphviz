...
![Screen capture of the settings worksheet and Settings ribbon tab.](../images/settings-worksheet.png)
...
If you're focused purely on Knowledge Graphs, a new toggle on the Launchpad tab lets you hide the Graphviz tab entirely.
