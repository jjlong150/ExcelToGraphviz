---
blogPost: true
title: New Label Template Feature
description: Relationship Visualizer 10.4 adds label templates with placeholders, letting you define reusable label formats for node, edge, and cluster labels.
date: 2026-04-27
author: jjlong150
