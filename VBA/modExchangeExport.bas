...
Private Function GetSettingsDictionarySettings(ByRef ini As settings) As Dictionary
    ...
    dictionaryObj.Add JSON_SETTINGS_GV_PATH, SettingsSheet.Range(SETTINGS_GV_PATH).Value
    dictionaryObj.Add JSON_SETTINGS_IMAGE_PATH, SettingsSheet.Range(SETTINGS_IMAGE_PATH).Value
    dictionaryObj.Add JSON_SETTINGS_GRAPH_OPTIONS, ini.graph.options
    dictionaryObj.Add JSON_SETTINGS_MAX_SECONDS, ini.graph.maxSeconds
